            ...
            addedLines.forEach(line => {
                ...
                if (parseResult) {
                    ...
                    window.getCurrentGame().then(currentGameNumber => {
                        ...
                        // Determine if this entity (attacker) should get a kill: " destroyed " appears after their vehicle
                        const killIdx = vehicleIdx === -1 ? -1 : lineText.indexOf(' destroyed ', vehicleIdx + vehicleText.length);
